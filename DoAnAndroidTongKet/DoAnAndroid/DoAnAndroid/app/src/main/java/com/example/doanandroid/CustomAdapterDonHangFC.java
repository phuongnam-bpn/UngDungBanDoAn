...
public class CustomAdapterDonHangFC extends ArrayAdapter {
    Context context;
    int layoutItem;
    ArrayList<DonHangInnerJoin> dsDonHangIJ = new ArrayList<>();

    public CustomAdapterDonHangFC(@NonNull Context context, int layoutItem, @NonNull ArrayList<DonHangInnerJoin> dsdh) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView anhCuaHang = (ImageView) convertView.findViewById(R.id.imgAnhQuanDHTG);
        ...
        TextView tenQuan = (TextView) convertView.findViewById(R.id.tvTenQuanDHTG);
        tenQuan.setText(donHangInnerJoin.getTenCuaHang());
        TextView khoangCach = (TextView) convertView.findViewById(R.id.tvKhoangCachDHTG);
